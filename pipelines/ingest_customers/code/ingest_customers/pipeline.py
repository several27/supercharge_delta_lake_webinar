...
def main():
    ...
    try:
        ...
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/ingest_customers", config = Config)
    except :
        
        MetricsCollector.start(spark = spark, pipelineId = "pipelines/ingest_customers")
