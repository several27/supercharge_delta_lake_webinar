...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "3436/pipelines/ingest_customers")
    MetricsCollector.start(spark = spark, pipelineId = "3436/pipelines/ingest_customers")
    pipeline(spark)
