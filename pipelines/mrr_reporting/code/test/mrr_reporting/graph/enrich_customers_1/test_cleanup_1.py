...
class cleanup_1Test(BaseTestCase):
    ...
    def test_unit_test_0(self):
        dfIn0 = createDfFromResourceFiles(
            ...
            'test/resources/data/mrr_reporting/graph/enrich_customers_1/cleanup_1/in0/data/test_unit_test_0.json',
            'in0'
        )
        dfOut = createDfFromResourceFiles(
            self.spark,
            'test/resources/data/mrr_reporting/graph/enrich_customers_1/cleanup_1/out/schema.json',
            'test/resources/data/mrr_reporting/graph/enrich_customers_1/cleanup_1/out/data/test_unit_test_0.json',
            'out'
        )
